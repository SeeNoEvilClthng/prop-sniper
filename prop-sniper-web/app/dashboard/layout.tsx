      ...
      {(meta.label === "Import CSV" || meta.label === "Map View") && (
        <section className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
          ...
          <section className="rounded-[30px] border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl">
            ...
            <div className="mt-4 grid gap-3">
              <LinkCard href="/dashboard/leads" label="All Leads" />
              <LinkCard href="/dashboard/tools/comps" label="Comp Finder" />
              <LinkCard href="/dashboard/analyzer" label="Deal Analyzer" />
            </div>
          </section>
        </section>
      )}
